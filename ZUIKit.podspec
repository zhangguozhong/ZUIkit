#
#  Be sure to run `pod spec lint ZUIKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  封装系统控件的初始化方法，便于纯代码界面开发者创建原生控件，减少冗余代码.
                   DESC

  s.homepage     = "https://github.com/zhangguozhong/ZUIkit.git"
  ...
  s.source       = { :git => "https://github.com/zhangguozhong/ZUIkit.git", :tag => "#{s.version}" }
